...
import ua.com.illia.service.OwnerPetServiceImpl;
...
public class OwnerPetController {
    ...
    private OwnerPetServiceImpl service = new OwnerPetServiceImpl();
    ...
    private void findAllOwners() {
        Collection<Owner> owners = service.findAllOwners();
        System.out.println();
    ...
    private void findOwnerByPet(BufferedReader reader) throws IOException {
        ...
        Pet pet = service.findPetById(id);
        if (pet != null) {
            Collection<Owner> owners = service.findOwnerByPetId(id);
            System.out.println();
